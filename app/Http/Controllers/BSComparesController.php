...
// bs monthly : yy, mm, acc, sum(amt) group by yy, mm into bsyymm
        ...
        $bscompares = DB::select ("select b.checkdate yymm,r.accid,sum(b.amt) aamt, min(bym.amt) camt from bscheckpoints b left join reconcile r on b.recid=r.id left join bsyymm bym on bym.yymm=b.checkdate and bym.accid=r.accid group by accid,b.checkdate order by accid, b.checkdate");
