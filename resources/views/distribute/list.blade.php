            ...
            <tr>
                ...
                <td>
                    @if(isset($row->posted_at))
                        Distributed!
                    @elseif(!isset($row->aid))
                        <a href='//dev.irealook.com/dist_photocost.php?aid={{ $row->keyv }}' target='_blank'>Distribute?</a>
                    @elseif($row->posted_at)
                        Distributed
                    @elseif(isset($row->aid) && !isset($row->posted_at))
                        <a href='//dev.irealook.com/dist_photocost.php?aid={{ $row->keyv }}' target='_blank'>Distributing</a>
                    @endif
